...
class Parametrization(ViktorParametrization) :
    ...
    tab_1.section_1.podW = NumberField("Podium Width", default= 50, step= 2, suffix= "m")
    tab_1.section_1.podWsplit = NumberField("Podium Width Split", default= 3, step= 1, variant="slider", min=1, max=6)
    tab_1.section_1.podLsplit = NumberField("Podium Length Split", default= 3, step= 1, variant="slider", min=1, max=6)
    tab_1.section_1.podFlrHt = NumberField("Podium Floor Ht", default= 4, step= 1,  variant="slider", min=4, max=6)
    tab_1.section_1.PodNoOfFlr = NumberField("No. of Podium Flrs", default= 2, step= 1, variant="slider", min=1, max=4)
    ...
    tab_1.section_1.PodscaleF = NumberField("Pod Window Size", default= 0.4, step= 0.1, variant="slider", min=0.4, max=0.8)
   
    
    tab_1.section_2 = Section("Building Parameters")
    tab_1.section_2.bldgWsplit = NumberField("Building Width Split", default= 3, step= 1,  variant="slider", min=1, max=6)
    tab_1.section_2.bldgLsplit = NumberField("Building Length Split", default= 3, step= 1,  variant="slider", min=1, max=6)
    tab_1.section_2.bldgFlrHt = NumberField("Building Floor Ht", default= 3, step= 1, variant="slider", min=3, max=4)
    tab_1.section_2.bldgNoOfFlr = NumberField("No. of Building Flrs", default= 8, suffix= "m", variant="slider", min=1, max=12)
    tab_1.section_2.bldgScaleF = NumberField(" Bldg Window Size", default= 0.5, step= 0.1, variant="slider", min=0.5, max=0.8)
    ...
    tab_1.section_3.scaleF = OptionField("Scale building", options = ["True", "False"], default = "True")
    tab_1.section_3.scaleV = NumberField("Scale Alternate Floors", default= 0.8, step= 0.1, variant="slider", min=0.5, max=0.9)
    tab_1.section_3.rotateV = NumberField("Building Rotation", default= 5, step= 2.5, suffix= "°", variant="slider", min=0, max=15)
    
    tab_2 = Tab("Topologic Feature")
    tab_2.PodFloorNo = NumberField("Podium Floor", default= 1, step= 1, min=0, max=100, description= "Internal vertical and external faces of a particular podium floor")
    tab_2.bldgFloorNo = NumberField("Building Floor", default= 1, step= 1, min=0, max=100, description= "Internal vertical and external faces of a particular building floor")
    tab_2.cellCheck =  NumberField("Tower Cell", default= 1, step= 1, min=0, max=100, description= "Select cell to check its adjacent topology")
